...
#define TOP_CLASS VMemoryControl
...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/curry/code/ysyx_curry/npc/test_run_dir/MemoryControl_should_read_data_from_memory/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_alu_result = u; break;
      case 2 : dut->io_reg2_data = u; break;
      case 3 : dut->io_memory_read_enable = u; break;
      case 4 : dut->io_memory_write_enable = u; break;
      case 5 : dut->io_funct3 = u; break;
      case 6 : dut->io_memory_bundle_read_data = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_alu_result; break;
      case 2 : value = dut->io_reg2_data; break;
      case 3 : value = dut->io_memory_read_enable; break;
      case 4 : value = dut->io_memory_write_enable; break;
      case 5 : value = dut->io_funct3; break;
      case 6 : value = dut->io_memory_bundle_read_data; break;
      case 7 : value = dut->io_wb_memory_read_data; break;
      case 8 : value = dut->io_memory_bundle_address; break;
      case 9 : value = dut->io_memory_bundle_write_data; break;
      case 10 : value = dut->io_memory_bundle_write_enable; break;
      case 11 : value = dut->io_memory_bundle_write_strobe_0; break;
      case 12 : value = dut->io_memory_bundle_write_strobe_1; break;
      case 13 : value = dut->io_memory_bundle_write_strobe_2; break;
      case 14 : value = dut->io_memory_bundle_write_strobe_3; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/curry/code/ysyx_curry/npc/test_run_dir/MemoryControl_should_read_data_from_memory/MemoryControl.)";
