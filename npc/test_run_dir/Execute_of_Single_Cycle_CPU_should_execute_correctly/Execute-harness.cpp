...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/curry/code/ysyx_curry/npc/test_run_dir/Execute_of_Single_Cycle_CPU_should_execute_correctly/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/curry/code/ysyx_curry/npc/test_run_dir/Execute_of_Single_Cycle_CPU_should_execute_correctly/Execute.)";
